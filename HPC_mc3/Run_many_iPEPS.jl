...
function genScript(para::Dict{Symbol,Any})
    ...
    str = string(
        ...
        echo 'Job Started at'
        date
        MKL_NUM_THREADS=$ncpu /public/home/users/ucas001c/julia1.10/julia-1.10.3/bin/julia --project=/public/home/users/ucas001c/julia1.10/jl20240601 --heap-size-hint=90G main_iPEPS.jl $parpath
