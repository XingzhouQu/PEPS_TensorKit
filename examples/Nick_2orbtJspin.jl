...
include("../models/tJspin_Z2SU2_2orb.jl")
...
function main()
    ...
    para[:Dk] = 5  # Dkept in the simple udate
    ...
    para[:pspace] = Z₂SU₂tJspin2orb.pspace
    pspace = Z₂SU₂tJspin2orb.pspace
    ...
    site1Obs = ["Nx", "Δₛx", "Δₛdagx"]   # 计算这些单点观测量
