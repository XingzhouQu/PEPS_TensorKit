...
function main()
    ...
    para[:pspace] = Rep[ℤ₂×SU₂]((0, 0) => 1, (1, 1 // 2) => 1)
    pspace = Rep[ℤ₂×SU₂]((0, 0) => 1, (1, 1 // 2) => 1)
    ...
    site2Obs = ["hijNN", "SS", "NN", "Δₛ", "Δₛdag"]   # 计算这些两点观测量
    site2Obsdiag = ["hijNNN", "SS", "NN", "Δₛ", "Δₛdag"]
