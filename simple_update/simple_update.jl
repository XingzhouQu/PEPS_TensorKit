...
function bond_proj_lr!(ipeps::iPEPSΓΛ, xx::Int, yy::Int, Dk::Int, gateNN::TensorMap)
    # 生成左侧交换门
    swgate = swap_gate(space(ipeps[xx, yy].Γ)[3]', space(ipeps[xx, yy].Γ)[5]')
    @tensor Γl[l, t, p; r, b] := ipeps[xx, yy].Γ[le, te, pin, r, be] * ipeps[xx, yy].l[l, le] * ipeps[xx, yy].t[t, te] *
    ...
    @tensor Γlnew[l, t, p; r, b] := Xl[le, te, bein, toX] * vnew[toX, pin, r] * swgate[pin, bein, p, be] *
